...
<link rel="stylesheet" href="<?php echo e(asset('css/manage_product/product/style.css')); ?>">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-start">
      	<div class="dropdown">
            ...
            <?php if($supply_system->status == true): ?>
        ...
        <div class="dropdown dropdown-search">
	      ...
	      <a href="<?php echo e(url('/product/new')); ?>" class="btn btn-icons btn-inverse-primary btn-new ml-2">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="<?php echo e(url('/product/update')); ?>" method="post" name="update_form">
          ...
          <div class="modal-body" id="edit-modal-body">
              ...
              <div class="form-group row" <?php if($supply_system->status == false): ?> hidden="" <?php endif; ?>>
...
<div class="row">
  <div class="col-12">
    <div class="alert alert-primary d-flex justify-content-between align-items-center" role="alert">
      <?php if($supply_system->status == false): ?>
      ...
      <a href="<?php echo e(url('/supply/system/active')); ?>" class="btn stok-btn">Aktifkan</a>
      <?php else: ?>
      <div class="text-instruction">
        <i class="mdi mdi-information-outline mr-2"></i> Nonaktifkan sistem stok dan pasok barang dengan klik tombol disamping
      </div>
      <a href="<?php echo e(url('/supply/system/nonactive')); ?>" class="btn stok-btn">Nonaktifkan</a>
      <?php endif; ?>
    </div>
  </div>
        	...
        	<div class="col-12 table-responsive">
              ...
              <tbody>
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              	<tr>
                  <td>
                    <span class="kd-barang-field"><?php echo e($product->kode_barang); ?></span><br><br>
                    <span class="nama-barang-field"><?php echo e($product->nama_barang); ?></span>
                  </td>
                  <td><?php echo e($product->jenis_barang); ?></td>
                  <td><?php echo e($product->berat_barang); ?></td>
                  <td><?php echo e($product->merek); ?></td>
                  <?php if($supply_system->status == true): ?>
                  <td><span class="ammount-box bg-secondary"><i class="mdi mdi-cube-outline"></i></span><?php echo e($product->stok); ?></td>
                  <?php endif; ?>
                  <td><span class="ammount-box bg-green"><i class="mdi mdi-coin"></i></span>Rp. <?php echo e(number_format($product->harga,2,',','.')); ?></td>
                  <?php if($supply_system->status == true): ?>
                  <td>
                    <?php if($product->keterangan == 'Tersedia'): ?>
                    <span class="btn tersedia-span"><?php echo e($product->keterangan); ?></span>
                    <?php else: ?>
                    <span class="btn habis-span"><?php echo e($product->keterangan); ?></span>
                    <?php endif; ?>
                  </td>
                  <?php endif; ?>
                  <td>
                    <button type="button" class="btn btn-edit btn-icons btn-rounded btn-secondary" data-toggle="modal" data-target="#editModal" data-edit="<?php echo e($product->id); ?>">
                        <i class="mdi mdi-pencil"></i>
                    </button>
                    <button type="button" class="btn btn-icons btn-rounded btn-secondary ml-1 btn-delete" data-delete="<?php echo e($product->id); ?>">
...
<script src="<?php echo e(asset('plugins/js/quagga.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/manage_product/product/script.js')); ?>"></script>
<script type="text/javascript">
  ...
  <?php if($message = Session::get('import_success')): ?>
    swal(
        "Berhasil!",
        "<?php echo e($message); ?>",
        "success"
  ...
  <?php if($message = Session::get('update_failed')): ?>
    swal(
        "",
        "<?php echo e($message); ?>",
        "error"
  ...
  <?php if($message = Session::get('supply_system_status')): ?>
    swal(
        "",
        "<?php echo e($message); ?>",
        "success"
  ...
  $(document).on('click', '.filter-btn', function(e){
    ...
    $.ajax({
      method: "GET",
      url: "<?php echo e(url('/product/filter')); ?>/" + data_filter,
  ...
  $(document).on('click', '.btn-edit', function(){
    ...
    $.ajax({
      method: "GET",
      url: "<?php echo e(url('/product/edit')); ?>/" + data_edit,
  ...
  $(document).on('click', '.btn-delete', function(e){
    ...
    .then((willDelete) => {
      if (willDelete) {
        window.open("<?php echo e(url('/product/delete')); ?>/" + data_delete, "_self");
      }
    });
  });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipos-system-master\resources\views/manage_product/product.blade.php ENDPATH**/ ?>