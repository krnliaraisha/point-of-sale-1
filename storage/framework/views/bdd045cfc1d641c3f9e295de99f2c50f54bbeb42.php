...
<link rel="stylesheet" href="<?php echo e(asset('css/report/report_transaction/style.css')); ?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(url('/report/transaction/export')); ?>" name="export_form" method="POST" target="_blank">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-12">
...
<script src="<?php echo e(asset('js/report/report_transaction/script.js')); ?>"></script>
...
$(document).on('submit', 'form[name=filter_form]', function(e){
  ...
  $.ajax({
      url: "<?php echo e(url('/report/transaction/filter')); ?>",
      method: "POST",
      data: request,
      contentType: false,
      cache: false,
...
$(document).on('click', '.chart-filter', function(e){
  ...
  $.ajax({
    url: "<?php echo e(url('/report/transaction/chart')); ?>/" + data_filter,
    method: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipos-system-master\resources\views/report/report_transaction.blade.php ENDPATH**/ ?>