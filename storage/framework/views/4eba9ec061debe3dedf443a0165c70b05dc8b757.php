  ...
  <div class="modal fade" id="pengaturanTokoModal" tabindex="-1" role="dialog" aria-labelledby="pengaturanTokoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form name="market_form" action="<?php echo e(url('/market/update')); ?>" method="POST">
          <?php echo csrf_field(); ?>
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <input type="text" class="form-control" name="nama_toko" placeholder="Masukkan Nama Toko" value="<?php echo e($market->nama_toko); ?>">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <input type="text" class="form-control" name="no_telp" placeholder="Masukkan No Telepon" value="<?php echo e($market->no_telp); ?>">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <textarea class="form-control" name="alamat" rows="4" placeholder="Masukkan Alamat"><?php echo e($market->alamat); ?></textarea>
                  </div>
            ...
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                ...
                <div class="ml-3">
                  ...
                  <h5 class="text-white"><?php echo e(number_format($incomes_daily,2,',','.')); ?></h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                ...
                <div class="ml-3">
                  ...
                  <h5><?php echo e($customers_daily); ?> Orang</h5>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <h2 class="font-weight-bold">Rp. <?php echo e(number_format($all_incomes,2,',','.')); ?></h2>
            <p class="m-0 txt-light"><?php echo e(date('d M, Y', strtotime($min_date))); ?> - <?php echo e(date('d M, Y', strtotime($max_date))); ?></p>
          </div>
          ...
          <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              ->first();
              ?>
              <button class="btn btn-view-transaction" type="button" data-access="<?php echo e($access->kelola_laporan); ?>">Semua</button>
            </div>  
          </div>
          <div class="col-12">
            <?php $__currentLoopData = $kd_transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="text-group mt-3">
              <div class="d-flex justify-content-between">
                <div class="d-flex justify-content-start">
                  ...
                  <div class="ml-2">
                    <p class="kode_transaksi font-weight-semibold"><?php echo e($transaksi->kode_transaksi); ?></p>
                    <p class="des-transaksi">Rp. <?php echo e(number_format($ket_transaksi->total,2,',','.')); ?> <span class="dot"><i class="mdi mdi-checkbox-blank-circle"></i></span> <?php echo e($ket_transaksi->kasir); ?></p>
                  </div>
                </div>
                <span class="w-transaksi"><?php echo e(Carbon\Carbon::parse($ket_transaksi->created_at)->diffForHumans()); ?></span>
              </div>
            </div>
...
<script src="<?php echo e(asset('js/dashboard/script.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/js/Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/js/ChartRadius.js')); ?>"></script>
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        "<?php echo e(date('d M, Y', strtotime($income))); ?>",
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        ],
        datasets: [{
...
$(document).on('click', '.chart-filter', function(e){
  ...
  $.ajax({
    url: "<?php echo e(url('/dashboard/chart')); ?>/" + data_filter,
    method: "GET",
...
$(document).on('click', '.btn-view-transaction', function(){
  ...
  if(check_access == 1){
    window.open("<?php echo e(url('/report/transaction')); ?>", "_self");
  }else{
    swal(
        "",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipos-system-master\resources\views/dashboard.blade.php ENDPATH**/ ?>