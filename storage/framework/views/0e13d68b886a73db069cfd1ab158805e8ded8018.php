...
<link rel="stylesheet" href="<?php echo e(asset('css/transaction/style.css')); ?>">
...
<div class="row modal-group">
              ...
              <ul class="list-group product-list">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center active-list">
                  <div class="text-group">
                    <p class="m-0"><?php echo e($product->kode_barang); ?></p>
                    <p class="m-0 txt-light"><?php echo e($product->nama_barang); ?></p>
                  </div>
                  <div class="d-flex align-items-center">
                    <span class="ammount-box bg-secondary mr-1"><i class="mdi mdi-cube-outline"></i></span>
                    <p class="m-0"><?php echo e($product->stok); ?></p>
                  </div>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center active-list">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <p class="m-0">Rp. <?php echo e(number_format($product->harga,2,',','.')); ?></p>
                  </div>
                  <a href="#" class="btn btn-icons btn-rounded btn-inverse-outline-primary font-weight-bold btn-pilih" role="button"><i class="mdi mdi-chevron-right"></i></a>
                </li>
                <?php endif; ?>
  ...
  <?php if($message = Session::get('transaction_success')): ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body bg-grey">
          <div class="row">
            <div class="col-12 text-center mb-4">
              <img src="<?php echo e(asset('gif/success4.gif')); ?>">
            ...
            <div class="col-12">
              <table class="table-receipt">
                <tr>
                  <td>
                    ...
                    <span class="d-block font-weight-bold"><?php echo e($message); ?></span>
                  </td>
                  <td>
                    <span class="d-block little-td">Tanggal</span>
                    <span class="d-block font-weight-bold"><?php echo e(date('d M, Y', strtotime($transaksi->created_at))); ?></span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <span class="d-block little-td">Kasir</span>
                    <span class="d-block font-weight-bold"><?php echo e($transaksi->kasir); ?></span>
                  </td>
                  <td>
                    <span class="d-block little-td">Total</span>
                    <span class="d-block font-weight-bold text-success">Rp. <?php echo e(number_format($transaksi->total,2,',','.')); ?></span>
                  </td>
                </tr>
              </table>
              <table class="table-summary mt-3">
                ...
                <tr>
                  ...
                  <td>Rp. <?php echo e(number_format($transaksi->bayar,2,',','.')); ?></td>
                </tr>
                <tr>
        ...
        <div class="modal-footer">
          ...
          <a href="<?php echo e(url('/transaction/receipt/' . $message)); ?>" target="_blank" class="btn btn-sm btn-cetak-pdf">Cetak Struk</a>
        </div>
      </div>
    </div>
  </div>
...
<form method="POST" name="transaction_form" id="transaction_form" action="<?php echo e(url('/transaction/process')); ?>">
  <?php echo csrf_field(); ?>
  <div class="row">
                ...
                <div class="col-12 d-flex justify-content-between align-items-center transaction-header">
                  <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="transaction-code ml-3">
                      ...
                      <p class="m-0 text-white">T<?php echo e(date('dmYHis')); ?></p>
                      <input type="text" name="kode_transaksi" value="T<?php echo e(date('dmYHis')); ?>" hidden="">
                    </div>
                  </div>
            ...
            <div class="col-12 payment-1">
              <table class="table-payment-1">
                <tr>
                  ...
                  <td class="text-right"><?php echo e(date('d M, Y')); ?></td>
                </tr>
                <tr>
                  <td class="text-left">Waktu</td>
                  <td class="text-right"><?php echo e(date('H:i')); ?></td>
                </tr>
                <tr>
                  <td class="text-left">Kasir</td>
                  <td class="text-right"><?php echo e(auth()->user()->nama); ?></td>
                </tr>
              </table>
            </div>
...
<script src="<?php echo e(asset('js/transaction/script.js')); ?>"></script>
...
$(document).on('click', '.btn-pilih', function(e){
  ...
  $.ajax({
    url: "<?php echo e(url('/transaction/product')); ?>/" + kode_barang,
    method: "GET",
...
$(document).on('click', '.btn-continue', function(e){
  ...
  $.ajax({
    url: "<?php echo e(url('/transaction/product/check')); ?>/" + kode_barang,
    method: "GET",
    success:function(response){
      var check = $('.kode-barang-td:contains('+ response.product.kode_barang +')').length;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipos-system-master\resources\views/transaction/transaction.blade.php ENDPATH**/ ?>